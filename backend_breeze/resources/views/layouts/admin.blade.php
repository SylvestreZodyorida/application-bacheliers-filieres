...
<head>
    ...
    <link href="{{ asset('admin_asset/assets/extra-libs/jvector/jquery-jvectormap-2.0.2.css')}}" rel="stylesheet" />
    <!-- Custom CSS -->
...
<body>
                ...
                <div class="navbar-header" data-logobg="skin6">
                    ...
                    <div class="navbar-brand">
                        ...
                        <a href="index.html">
                            <b class="logo-icon">
                                <!-- Dark Logo icon -->
                                <img src="{{ asset('admin_asset/assets/images/logo-icon.png')}}" alt="homepage" class="dark-logo" />
                                <!-- Light Logo icon -->
                            ...
                            <span class="logo-text">
                                <!-- dark Logo text -->
                                <img src="{{ asset('admin_asset/assets/images/logo-text.png')}}" alt="homepage" class="dark-logo" />
                                <!-- Light Logo text -->
                                <img src="{{ asset('admin_asset/assets/images/logo-light-text.png')}}" class="light-logo" alt="homepage" />
                            </span>
                        </a>
                    </div>
                    <!-- ============================================================== -->
                    ...
                    <ul class="navbar-nav float-right">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="javascript:void(0)" data-toggle="dropdown"
                                ...
                                {{-- <img src="{{ asset('admin_asset/assets/images/users/profile-pic.jpg')}}" alt="user" class="rounded-circle"
                                    width="40"> --}}
                                <span class="ml-2 d-none d-lg-inline-block"><span> </span> <span
                                        class="text-dark">{{  Auth::user()->surname }} {{  Auth::user()->name }}</span> <i data-feather="chevron-down"
                        ...
                        <li class="sidebar-item">
                            <form method="POST" action="{{ route('logout') }}">
                                ...
                                <a class="sidebar-link sidebar-link" href="{{ route('logout') }}" onclick="event.preventDefault();
                                    this.closest('form').submit();"><i data-feather="log-out" class="feather-icon"></i><span
    ...
    <!-- apps --><script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.1/dist/js/bootstrap.bundle.min.js"></script>
    <!-- apps -->
    <script src="{{ asset('admin_asset/dist/js/app-style-switcher.js')}}"></script>
    <script src="{{ asset('admin_asset/dist/js/feather.min.js')}}"></script>
    ...
    <script src="{{ asset('admin_asset/assets/libs/chartist-plugin-tooltips/dist/chartist-plugin-tooltip.min.js')}}"></script>
    <script src="{{ asset('admin_asset/assets/extra-libs/jvector/jquery-jvectormap-2.0.2.min.js')}}"></script>
    <script src="{{ asset('admin_asset/assets/extra-libs/jvector/jquery-jvectormap-world-mill-en.js')}}"></script>
    <script src="{{ asset('admin_asset/dist/js/pages/dashboards/dashboard1.min.js')}}"></script>
</body>
